...
int main() {
    ...
    if (!dmk::folderExists(cooked)) {
        ...
        std::fprintf(out, "\nПакетов дополнений: %d\n", dlcCount);
        std::printf("Пакетов: %u, из них дополнений: %d\n",
