...
export const ICONS = {
  ...
  key: '<circle cx="8" cy="12" r="4.5"/><path d="M12.5 12H21"/><path d="M17 12v3.5M20 12v2.5"/>',
  gear: '<circle cx="12" cy="12" r="3.2"/><path d="M12 2.8v2.6M12 18.6v2.6M4.5 7.5l2.3 1.3M17.2 15.2l2.3 1.3M4.5 16.5l2.3-1.3M17.2 8.8l2.3-1.3"/>',
