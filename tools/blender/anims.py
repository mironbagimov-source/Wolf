...
def build_activate(arm: bpy.types.Object) -> None:
    """Активация: рука взлетает к груди, щёлкает тумблером, падает вниз."""
    keys = [
        (0, {"RightArm": (0, 0, 0), "RightForeArm": (0, 0, 0), "RightHand": (0, 0, 0),
             "Spine1": (0, 0, 0), "Neck": (0, 0, 0)}),
        # рывок к груди
        (5, {"RightArm": (0, 0, -62), "RightForeArm": (78, 0, 0), "RightHand": (-18, 0, 0),
             "Spine1": (4, 0, -3), "Neck": (6, -8, 0)}),
        # щелчок
        (8, {"RightArm": (0, 0, -58), "RightForeArm": (86, 0, 0), "RightHand": (24, 0, 0),
             "Spine1": (6, 0, -3), "Neck": (8, -8, 0)}),
        (11, {"RightArm": (0, 0, -60), "RightForeArm": (80, 0, 0), "RightHand": (-8, 0, 0),
              "Spine1": (5, 0, -3), "Neck": (7, -8, 0)}),
        # рука вниз
        (21, {"RightArm": (0, 0, 0), "RightForeArm": (0, 0, 0), "RightHand": (0, 0, 0),
              "Spine1": (0, 0, 0), "Neck": (0, 0, 0)}),
    ]
